...
bool TallinnTauMaker::addPFChargedHadron( l1t::PFCandidate in ){
...
bool TallinnTauMaker::seedCHConeContains( l1t::PFCandidate in ){
  if(!seedHadronSet){
...
bool TallinnTauMaker::contains(l1t::PFCandidate in){
...
bool TallinnTauMaker::isolationConeContains( l1t::PFCandidate in ){
...
void TallinnTauMaker::buildStripGrid(){
  if(!seedHadronSet){
...
bool TallinnTauMaker::addEG( l1t::PFCandidate in ){
...
void TallinnTauMaker::process_strip(){
...
void TallinnTauMaker::merge_strip(simple_object_t cluster_1, simple_object_t cluster_2, simple_object_t &strip){
...
float TallinnTauMaker::delta_r_cluster(simple_object_t cluster_1, simple_object_t cluster_2){
  float delta_r = 20;
...
float TallinnTauMaker::weighted_avg_phi(simple_object_t cluster_1, simple_object_t cluster_2){
  float total_pt = (cluster_1.et+cluster_2.et);
  float avg_phi = (cluster_1.phi*cluster_1.et + cluster_2.phi*cluster_2.et)/total_pt;
  return avg_phi;
}

float TallinnTauMaker::weighted_avg_eta(simple_object_t cluster_1, simple_object_t cluster_2){
  float total_pt = (cluster_1.et+cluster_2.et);
...
TallinnTauMaker::TallinnTauMaker():m_minpi0pt(0) {};
TallinnTauMaker::~TallinnTauMaker() {};
