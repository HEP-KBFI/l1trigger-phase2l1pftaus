#ifndef L1Trigger_Phase2L1PFTau_TallinnTauMaker_h
#define L1Trigger_Phase2L1PFTau_TallinnTauMaker_h
...
class TallinnTauMaker;

typedef std::vector<TallinnTauMaker> tauMakerCollection;

class TallinnTauMaker{
      public:
  //TallinnTauMaker( const edm::ParameterSet& ) ;
